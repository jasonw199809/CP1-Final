...
## Summary
This game needs 2 active players. Each player has unlimited amount of bullet. The right user moves his/her players with UP and DOWN. Fires with SPACE (Bullet) and ENTER (Missile). The left user moves his/her players with A and Z. Fires with SHIFT (Bullet) and X (Missile). Missile refills immediately with a sucessful hit, refilles after 6 seconds if you miss. Players shoot at each other untill the last man down.
